...
{
    public partial class StadiumScreen : Form
    {
        ...
        private void StadiumScreen_Load(object sender, EventArgs e)
        {
        ...
        void doldur()
        {
            ...
            String sql = "";
            sql = "select StadiumName,StadiumAddress,Profit,Capacity from Stadium";
