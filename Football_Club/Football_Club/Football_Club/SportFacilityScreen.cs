...
{
    public partial class SportFacilityScreen : Form
    {
        public SportFacilityScreen()
        {
            InitializeComponent();
        }

        private void SportFacilityScreen_Load(object sender, EventArgs e)
        {
        ...
        void doldur()
        {
            ...
            String sql = "";
            sql = "select FacilityName,FacilityAddress, NumberOfPitch from Sport_Facility";
