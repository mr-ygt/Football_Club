...
{
    public partial class AchievementsScreen : Form
    {
        ...
        private void AchievementsScreen_Load(object sender, EventArgs e)
        {
        ...
        void doldur()
        {
            ...
            String sql = "";
            sql = "select LeagueChampion,NationalCupWinner,InternationalCupWinner from Achievement";
